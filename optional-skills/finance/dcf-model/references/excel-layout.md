# DCF Excel Layout Reference

**When to read this file:** when actually laying out the DCF/WACC sheets — exact row
structures, formatting/color/border standards, number formats, the sensitivity-table
grid locations, and the case-selector formula details. The body of SKILL.md gives the
workflow; this file gives the concrete cell-by-cell layout.
...
## Formula Recalculation Output Format

After running `python recalc.py [path_to_excel_file] [timeout_seconds]`, expect:
