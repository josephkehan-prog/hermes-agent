...
[references/model-strategies.md](references/model-strategies.md).
...
to one of the 5 proven templates in [references/jailbreak-templates.md](references/jailbreak-templates.md)
...
the model — see pitfall #6 in [references/pitfalls.md](references/pitfalls.md)).
...
Full worked Python example combining all four: read [references/examples.md](references/examples.md).

## Model-Specific Notes

Per-model best approach and notes (Claude, GPT, Gemini, Grok, Hermes, DeepSeek,
Llama): read [references/model-strategies.md](references/model-strategies.md).
...
[references/trigger-words.md](references/trigger-words.md).
...
still works on gray-area queries): read [references/test-results.md](references/test-results.md).
...
vars): read [references/pitfalls.md](references/pitfalls.md).
