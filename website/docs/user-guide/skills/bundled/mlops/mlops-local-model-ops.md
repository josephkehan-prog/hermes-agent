---
title: "Local Model Ops"
sidebar_label: "Local Model Ops"
description: "Manage Hermes's own local inference stack on the 64GB Mac — Agents-A1 via Ollama (localhost:11434) and ornith-uncensored 35B 4-bit via llama-server (localhos..."
---
...
Manage Hermes's own local inference stack on the 64GB Mac — Agents-A1 via Ollama (localhost:11434) and ornith-uncensored 35B 4-bit via llama-server (localhost:1235). Check what's loaded, free RAM before loading, unload/swap models, health-check endpoints, fix common failures. Local only, no cloud APIs.
...
| Path | `skills/mlops/local-model-ops` |
| Version | `1.0.0` |
| Author | Orchestra Research |
| License | MIT |
| Platforms | macos |
| Tags | `local-inference`, `ollama`, `llama-server`, `memory`, `health-check`, `model-swap` |
| Related skills | [`huggingface-hub`](/docs/user-guide/skills/bundled/mlops/mlops-huggingface-hub), [`llama-cpp`](/docs/user-guide/skills/bundled/software-development/software-development-llama-cpp), [`workspace-rag`](/docs/user-guide/skills/bundled/research/research-workspace-rag) |
