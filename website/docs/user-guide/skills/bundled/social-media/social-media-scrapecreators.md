...
sidebar_label: "Scrapecreators"
description: "ScrapeCreators API wrapper for public social-media profile/post scraping across TikTok, Instagram, YouTube, X/Twitter, Reddit, LinkedIn, Facebook, Threads"
---
...
ScrapeCreators API wrapper for public social-media profile/post scraping across TikTok, Instagram, YouTube, X/Twitter, Reddit, LinkedIn, Facebook, Threads. PAID API — requires SCRAPECREATORS_API_KEY. Includes scripts/scrapecreators.py.
...
| Path | `skills/social-media/scrapecreators` |
| Version | `1.0.0` |
| Author | Hermes Agent |
| License | MIT |
| Platforms | linux, macos, windows |
| Tags | `Social Media`, `Scraping`, `TikTok`, `Instagram`, `YouTube`, `Twitter`, `Profiling`, `API` |
| Related skills | [`scrapling`](/docs/user-guide/skills/bundled/scrapling/scrapling-scrapling), [`social-footprint`](/docs/user-guide/skills/bundled/research/research-social-footprint), [`duckduckgo-search`](/docs/user-guide/skills/bundled/duckduckgo-search/duckduckgo-search-duckduckgo-search) |
...
|------|-------|----------|-----|
| Deterministic field extraction from the JSON response (e.g. "pull follower_count/bio/handle as JSON") | **agent1** | Ollama `http://localhost:11434/api/chat`, `"options": {"temperature": 0}` | Temperature 0 for repeatable structured output |
...
# agent1: deterministic field extraction, temperature 0
payload = {
