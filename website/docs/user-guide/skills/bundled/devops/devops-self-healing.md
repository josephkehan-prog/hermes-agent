---
title: "Self Healing"
sidebar_label: "Self Healing"
description: "Monitor→detect→remediate runbook engine for local services — HTTP/process/disk/load health checks, gated destructive remediation (restart/clear-temp), and nt..."
---
...
| Path | `skills/devops/self-healing` |
| Version | `1.0.0` |
| Author | Hermes Agent |
| License | MIT |
| Platforms | linux, macos |
| Tags | `DevOps`, `Self-Healing`, `Monitoring`, `Remediation`, `Health-Check`, `Automation` |
| Related skills | [`watch-notify`](/docs/user-guide/skills/bundled/research/research-watch-notify), [`local-model-ops`](/docs/user-guide/skills/bundled/mlops/mlops-local-model-ops) |
...
[watch-notify's ntfy topic privacy note](https://github.com/NousResearch/hermes-agent/blob/main/skills/devops/self-healing/../../research/watch-notify/SKILL.md#notification-backends)).
