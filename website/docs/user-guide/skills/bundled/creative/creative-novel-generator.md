...
sidebar_label: "Novel Generator"
description: "Generate full novels autonomously via Claude Code or Codex — one-shot creative writing agents that plan, draft chapters, and deliver a complete manuscript wi..."
---
...
Generate full novels autonomously via Claude Code or Codex — one-shot creative writing agents that plan, draft chapters, and deliver a complete manuscript without human-in-the-loop each turn.
...
| Path | `skills/creative/novel-generator` |
| Version | `1.0.0` |
| Author | Hermes Agent |
| License | MIT |
| Platforms | linux, macos, windows |
| Tags | `novel`, `fiction`, `creative-writing`, `autonomous-agent`, `story-generation`, `manuscript`, `chapters` |
| Related skills | [`claude-code`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-claude-code), [`codex`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-codex), [`humanizer`](/docs/user-guide/skills/bundled/creative/creative-humanizer), [`songwriting-and-ai-music`](/docs/user-guide/skills/bundled/creative/creative-songwriting-and-ai-music) |
