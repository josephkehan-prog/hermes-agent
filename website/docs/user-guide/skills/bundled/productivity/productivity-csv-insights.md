...
Use when the user wants to inspect, summarize, filter, or compute aggregates over a CSV, TSV, or other delimited data file.
...
| Path | `skills/productivity/csv-insights` |
| Version | `1.0.0` |
| Author | Hermes Agent |
| License | MIT |
| Platforms | linux, macos, windows |
| Tags | `csv`, `data`, `tabular`, `analysis`, `spreadsheet` |
| Related skills | [`ocr-and-documents`](/docs/user-guide/skills/bundled/productivity/productivity-ocr-and-documents), [`jupyter-live-kernel`](/docs/user-guide/skills/bundled/data-science/data-science-jupyter-live-kernel) |
