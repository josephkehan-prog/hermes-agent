---
title: "Resume Tailor"
sidebar_label: "Resume Tailor"
description: "Tailor a base resume to a specific job posting — extract required keywords, map them to the user's existing experience, and produce edited bullet points"
---
...
Tailor a base resume to a specific job posting — extract required keywords, map them to the user's existing experience, and produce edited bullet points. No cloud API, no paid resume tools.
...
| Path | `skills/productivity/resume-tailor` |
| Version | `1.0.0` |
| Author | Hermes Agent |
| License | MIT |
| Platforms | linux, macos, windows |
| Tags | `resume`, `job-search`, `career`, `teaching`, `keywords` |
| Related skills | [`job-search-tracking`](/docs/user-guide/skills/bundled/productivity/productivity-job-search-tracking), [`cover-letter`](/docs/user-guide/skills/bundled/productivity/productivity-cover-letter), [`interview-prep`](/docs/user-guide/skills/bundled/productivity/productivity-interview-prep) |
