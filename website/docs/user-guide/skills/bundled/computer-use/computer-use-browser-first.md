---
title: "Browser First"
sidebar_label: "Browser First"
description: "For ANY web task (open a URL, read a page, search, dork, fetch a profile, click, fill a form), use the browser toolset — NOT computer_use"
---
...
| Path | `skills/computer-use/browser-first` |
| Version | `1.0.0` |
| Author | Hermes Agent |
| License | MIT |
| Platforms | macos |
| Tags | `browser`, `computer-use`, `cdp`, `chrome`, `web`, `routing`, `do-not-screen-control` |
| Related skills | [`osint-investigation`](/docs/user-guide/skills/bundled/osint-investigation/osint-investigation-osint-investigation), [`local-model-ops`](/docs/user-guide/skills/bundled/mlops/mlops-local-model-ops) |
