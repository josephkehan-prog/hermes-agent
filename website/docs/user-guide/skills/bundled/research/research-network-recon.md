---
title: "Network Recon"
sidebar_label: "Network Recon"
description: "Keyless DNS and infrastructure reconnaissance — DNS-over-HTTPS record lookup, Certificate Transparency subdomain discovery (crt"
---
...
Keyless DNS and infrastructure reconnaissance — DNS-over-HTTPS record lookup, Certificate Transparency subdomain discovery (crt.sh), reverse DNS/PTR, WHOIS, HTTP header/security-header fingerprinting. Includes scripts/recon.py.
...
| Path | `skills/research/network-recon` |
| Version | `1.0.0` |
| Author | Hermes Agent |
| License | MIT |
| Platforms | linux, macos, windows |
| Tags | `OSINT`, `Recon`, `DNS`, `Certificate Transparency`, `Infrastructure`, `Security` |
| Related skills | [`osint-investigation`](/docs/user-guide/skills/bundled/osint-investigation/osint-investigation-osint-investigation), [`scrapling`](/docs/user-guide/skills/bundled/scrapling/scrapling-scrapling), [`open-databases`](/docs/user-guide/skills/bundled/research/research-open-databases) |
