---
title: "Market Pulse"
sidebar_label: "Market Pulse"
description: "One-shot market-snapshot dashboard combining keyless crypto and prediction-market signals — top coin prices, the Fear & Greed Index, and Polymarket's trendin..."
---
...
One-shot market-snapshot dashboard combining keyless crypto and prediction-market signals — top coin prices, the Fear & Greed Index, and Polymarket's trending markets — into a single "how's the market doing" read. Includes scripts/pulse.py.
...
| Path | `skills/research/market-pulse` |
| Version | `1.0.0` |
| Author | Hermes Agent |
| License | MIT |
| Platforms | linux, macos, windows |
| Tags | `Crypto`, `Markets`, `Sentiment`, `Dashboard`, `Finance`, `Prediction-Markets` |
| Related skills | [`crypto-market`](/docs/user-guide/skills/bundled/research/research-crypto-market), [`polymarket`](/docs/user-guide/skills/bundled/research/research-polymarket), [`deal-hunting`](/docs/user-guide/skills/bundled/research/research-deal-hunting) |
