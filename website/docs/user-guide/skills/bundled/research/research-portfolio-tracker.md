---
title: "Portfolio Tracker — Keyless crypto portfolio valuation from a local holdings file (JSON list of {coin_id, amount})"
sidebar_label: "Portfolio Tracker"
description: "Keyless crypto portfolio valuation from a local holdings file (JSON list of {coin_id, amount})"
---
...
Keyless crypto portfolio valuation from a local holdings file (JSON list of &#123;coin_id, amount&#125;). Fetches spot prices from CoinGecko in one batched call, computes per-holding and total value, and reports risk/concentration reads. Includes scripts/portfolio.py.
...
| Path | `skills/research/portfolio-tracker` |
| Version | `1.0.0` |
| Author | Hermes Agent |
| License | MIT |
| Platforms | linux, macos, windows |
| Tags | `Crypto`, `Portfolio`, `Finance`, `Tracking`, `Valuation` |
| Related skills | [`crypto-market`](/docs/user-guide/skills/bundled/research/research-crypto-market), [`polymarket`](/docs/user-guide/skills/bundled/research/research-polymarket) |
