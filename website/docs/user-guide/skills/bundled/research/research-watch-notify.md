---
title: "Watch Notify"
sidebar_label: "Watch Notify"
description: "Generic \"watch a source, detect a change, alert\" monitoring engine — content-hash diffing for any URL, JSON-field value tracking, and keyless push notificati..."
---
...
Generic "watch a source, detect a change, alert" monitoring engine — content-hash diffing for any URL, JSON-field value tracking, and keyless push notification via ntfy.sh. No external CLI, no API keys. Includes scripts/watch.py.
...
| Path | `skills/research/watch-notify` |
| Version | `1.0.0` |
| Author | Hermes Agent |
| License | MIT |
| Platforms | linux, macos, windows |
| Tags | `Monitoring`, `Alerting`, `Change-Detection`, `Watch`, `Automation` |
| Related skills | [`blogwatcher`](/docs/user-guide/skills/bundled/research/research-blogwatcher), [`deal-hunting`](/docs/user-guide/skills/bundled/research/research-deal-hunting), [`network-recon`](/docs/user-guide/skills/bundled/research/research-network-recon) |
...
| RSS/Atom new items | Feed polling, dedup, read/unread state | `blogwatcher-cli scan` (external CLI, see [blogwatcher](https://github.com/NousResearch/hermes-agent/blob/main/skills/research/watch-notify/../blogwatcher/SKILL.md)) — feed its "new" article list into `watch.py notify` for push alerts |
