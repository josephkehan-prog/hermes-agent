---
title: "Infra Monitor"
sidebar_label: "Infra Monitor"
description: "Infrastructure drift monitoring for a domain over time — DNS record changes, new/expiring TLS certs via Certificate Transparency logs, IP/ASN changes, and se..."
---
...
Infrastructure drift monitoring for a domain over time — DNS record changes, new/expiring TLS certs via Certificate Transparency logs, IP/ASN changes, and security-header regressions. Composes network-recon's DoH/crt.sh tooling into snapshot-and-diff workflows. Includes scripts/infra_snapshot.py.
...
| Path | `skills/research/infra-monitor` |
| Version | `1.0.0` |
| Author | Hermes Agent |
| License | MIT |
| Platforms | linux, macos, windows |
| Tags | `Monitoring`, `Infrastructure`, `DNS`, `Certificate`, `Drift-Detection`, `Security` |
| Related skills | [`network-recon`](/docs/user-guide/skills/bundled/research/research-network-recon), [`watch-notify`](/docs/user-guide/skills/bundled/research/research-watch-notify), `cert-transparency` |
