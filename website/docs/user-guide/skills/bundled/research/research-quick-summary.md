...
Use when the user asks to summarize, condense, TL;DR, or extract key points from a document, article, transcript, or long block of text.
...
| Path | `skills/research/quick-summary` |
| Version | `1.0.0` |
| Author | Hermes Agent |
| License | MIT |
| Platforms | linux, macos, windows |
| Tags | `summary`, `condense`, `extraction`, `reading` |
| Related skills | [`research-paper-writing`](/docs/user-guide/skills/bundled/research/research-research-paper-writing), [`workspace-rag`](/docs/user-guide/skills/bundled/research/research-workspace-rag) |
