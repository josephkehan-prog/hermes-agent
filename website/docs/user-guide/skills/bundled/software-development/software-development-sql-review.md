...
Use when the user wants a SQL query or statement reviewed for correctness, safety, and performance before running it.
...
| Path | `skills/software-development/sql-review` |
| Version | `1.0.0` |
| Author | Hermes Agent |
| License | MIT |
| Platforms | linux, macos, windows |
| Tags | `sql`, `database`, `review`, `query`, `performance` |
| Related skills | [`requesting-code-review`](/docs/user-guide/skills/bundled/software-development/software-development-requesting-code-review), [`systematic-debugging`](/docs/user-guide/skills/bundled/software-development/software-development-systematic-debugging) |
