---
title: "Software Delivery Bundle"
sidebar_label: "Software Delivery Bundle"
description: "Use when taking a software change from an unclear request through design, implementation, debugging, simplification, and review"
---
...
Use when taking a software change from an unclear request through design, implementation, debugging, simplification, and review. Routes each delivery stage to the smallest appropriate Hermes development skill.
...
| Path | `skills/software-development/software-delivery-bundle` |
| Version | `1.0.0` |
| Author | Hermes Agent |
| License | MIT |
| Platforms | linux, macos, windows |
| Tags | `bundle`, `software-delivery`, `implementation`, `quality` |
| Related skills | [`plan`](/docs/user-guide/skills/bundled/software-development/software-development-plan), [`spike`](/docs/user-guide/skills/bundled/software-development/software-development-spike), [`test-driven-development`](/docs/user-guide/skills/bundled/software-development/software-development-test-driven-development), [`systematic-debugging`](/docs/user-guide/skills/bundled/software-development/software-development-systematic-debugging), [`simplify-code`](/docs/user-guide/skills/bundled/software-development/software-development-simplify-code), [`requesting-code-review`](/docs/user-guide/skills/bundled/software-development/software-development-requesting-code-review) |
