...
class TestWriteFileHandler:
    ...
    def test_writes_content(self, mock_get):
        ...
        # The tool canonicalizes the path (deref's the /tmp→/private/tmp
        # symlink on macOS); realpath makes the expectation portable (identity
        # on Linux, where /tmp is not a symlink).
