...
description: Run 150+ AI apps via the inference.sh CLI (infsh).
version: 1.0.0
author: okaris
license: MIT
...
> **Free alternative:** inference.sh requires INFSH_API_KEY (keyed platform). Local Ollama (localhost:11434) and local ComfyUI cover the common apps for free.
