---
name: 1password
description: Set up and use the 1Password CLI (op) for secrets.
version: 1.0.0
...
> **Free alternative:** 1Password is paid. Self-hosted open-source: Vaultwarden (github.com/dani-garcia/vaultwarden, ★63.5k, Bitwarden-compatible) or KeePassXC (★28k, local file, CLI: keepassxc-cli).
