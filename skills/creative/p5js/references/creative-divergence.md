...
Use only when the user requests experimental/creative/unique output. If the
user asks for creative, experimental, surprising, or unconventional output,
select the strategy that best fits and reason through its steps BEFORE
generating code.
