...
|------|-------|----------|-----|
| Deterministic market/odds extraction + dedup (e.g. "collapse these search/trending results into one JSON list of {question, yes_pct, no_pct, volume, slug}, drop duplicate markets") | **qwen3-coder** (`qwen3-coder`) | llama-swap, `http://localhost:1235/v1/chat/completions` | Temperature 0 for repeatable structured output |
...
# qwen3-coder: extract/dedup market fields, temperature 0
payload = {
    "model": "qwen3-coder",
    "messages": [
