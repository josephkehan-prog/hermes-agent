...
Read this when wiring local-model extraction (qwen3-coder/ornith) into a scraping workflow instead of hand-writing selectors.
...
|------|-------|----------|-----|
| Deterministic structured extraction (e.g. "pull name/title/date/price as JSON") | **qwen3-coder** (`qwen3-coder`) | llama-swap, `http://localhost:1235/v1/chat/completions` | Temperature 0 for repeatable output |
...
# qwen3-coder: deterministic structured JSON, temperature 0
payload = {
    "model": "qwen3-coder",
    "messages": [
