# Submission Preparation: Anonymization, Compilation, Camera-Ready, arXiv

Detailed procedures for Phase 7 (Submission Preparation): anonymization, pre-compilation validation, conference-specific requirements, format conversion between venues, camera-ready prep, arXiv strategy, and research code packaging.

---

## Contents

- [Anonymization Checklist](#anonymization-checklist)
- [Formatting Verification](#formatting-verification)
- [Pre-Compilation Validation](#pre-compilation-validation)
- [Final Compilation](#final-compilation)
- [Conference-Specific Requirements](#conference-specific-requirements)
- [Conference Resubmission & Format Conversion](#conference-resubmission--format-conversion)
- [Camera-Ready Preparation](#camera-ready-preparation-post-acceptance)
- [arXiv & Preprint Strategy](#arxiv--preprint-strategy)
- [Research Code Packaging](#research-code-packaging)
...
See [checklists.md](checklists.md) for the full per-venue checklist items.
...
## Camera-Ready Preparation (Post-Acceptance)
