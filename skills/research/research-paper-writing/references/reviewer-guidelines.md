...
- [Ensemble Review Simulation (Multi-Agent Pattern)](#ensemble-review-simulation-multi-agent-pattern)
- [Visual Review Pass (VLM)](#visual-review-pass-vlm)
- [Claim Verification Pass](#claim-verification-pass)
- [Pre-Submission Reviewer Simulation](#pre-submission-reviewer-simulation)
...
## Ensemble Review Simulation (Multi-Agent Pattern)

Generate reviews from multiple perspectives before submitting. The key insight from automated research pipelines (notably SakanaAI's AI-Scientist): **ensemble reviewing with a meta-reviewer produces far more calibrated feedback than a single review pass.**
...
**Few-shot calibration**: If available, include 1-2 real published reviews from the target venue as examples. This dramatically improves score calibration.

## Visual Review Pass (VLM)
