# LaTeX Tooling: Templates, Packages, Diagrams

Detailed LaTeX setup and packages for producing publication-quality papers: template workflow, professional preamble packages, table/figure patterns, diagrams, and revision tooling.

---

## Contents

- [LaTeX Quality Checklist](#latex-quality-checklist)
