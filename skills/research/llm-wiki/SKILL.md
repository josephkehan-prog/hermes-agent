...
action log): read [references/templates.md](references/templates.md) when
initializing a new wiki.
...
`log.md`. Full checklist: read [references/lint.md](references/lint.md).
...
[references/obsidian.md](references/obsidian.md) when setting up Obsidian
