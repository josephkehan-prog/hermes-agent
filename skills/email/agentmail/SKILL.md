---
name: agentmail
description: Give the agent its own email inbox via AgentMail.
version: 1.0.0
...
> **Free alternative:** AgentMail is paid SaaS (~$20/mo past free tier). For normal send/read/search use the installed free `email/himalaya` skill (IMAP/SMTP). AgentMail only needed for programmatic inbox provisioning.
