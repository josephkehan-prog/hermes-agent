---
name: pinecone
description: Managed vector database for RAG and semantic search.
version: 1.0.0
...
> **Free alternative:** Pinecone is a paid vector DB. Installed free alternative: `mlops/chroma` runs fully local (api_key only needed for Chroma Cloud). Zero-server options: sqlite-vec, FAISS.
